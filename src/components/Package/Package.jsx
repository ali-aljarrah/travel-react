...
function Package({img, date, people, title, desc, price, rate}) {
    return (
        <div className='package-card'>
            <div>
                <img width="346" height="223" loading="lazy" className='img-fluid' src={img} alt={title + ' ' + desc} />
                ...
                <div className="pack-info">
                    <div>{price}</div>
                    <div className='d-flex ms-4 justify-content-start align-items-center'>
